...
export function StreakBadge({ size = 'sm', className }: Props) {
  ...
  return (
    <span
      ...
      className={cn(
        'inline-flex items-center gap-1 border-1.5 border-ink-900 rounded-full bg-tangerine text-on-tangerine shadow-stamp-sm font-display font-bold whitespace-nowrap',
