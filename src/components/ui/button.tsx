  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap font-display font-bold transition-all btn-press disabled:opacity-50 disabled:pointer-events-none',
  {
    variants: {
      variant: {
        ...
        tangerine: 'bg-tangerine text-on-tangerine border-1.5 border-ink-900 shadow-stamp hover:brightness-110',
        lemon: 'bg-lemon text-on-lemon border-1.5 border-ink-900 shadow-stamp-sm hover:brightness-95',
        ...
        danger: 'bg-rose text-on-rose border-1.5 border-ink-900 shadow-stamp-sm hover:brightness-95',
      },
      size: {
